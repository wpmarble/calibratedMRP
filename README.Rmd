--- 
title: "calibratedMRP: An `R` package for improved small-area estimation with MRP"
output:
  github_document:
    html_preview: false
---
...
We will use data from an opt-in survey conducted in 2022 to estimate the share of people who believe that Joe Biden was legitimately elected in 2020. The survey asked three questions that we will include in analysis:
